  ...
  return (
    <div>
      ...
      <div className="surpriseBox">
        <h3 class="black-lives-matter">Bring your imaginations into reality!</h3>
      </div>
      <div className="Input-generate">
        ...
        />
        <button onClick={handleSurpriseMe} className="btn btn-outline-primary">Random Ideas</button>
      </div>
      ...
      <div>
        <button onClick={handleGenerate} className="btn btn-outline-primary">Generate the Image</button>
      </div>
      {showLoader ? (
